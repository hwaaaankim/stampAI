...
try {
    ...
    $message .= "<br /><br />4) Do you need installation service? " . $_POST['branchtype'] . "<br />";
        
    if(isset($_POST["quantity"]) && trim($_POST["quantity"]) != "") {
        $message .= "<br /><br />5) How many domain do you need to install: " . $_POST['quantity'] . "<br />";
    }
    if(isset($_POST["select_4"]) && trim($_POST["select_4"]) != "") {
        $message .= "<br />5) Why you don't need installation service? " . $_POST['select_4'] . "<br />";
    }
    $message .= "<strong>User personal details</strong>";
